...
d3.csv("js/csv/processed/income_group_by_year.csv", function (data) {
  ...
  var color = d3.scaleOrdinal()
    .domain(subgroups)
    .range(["rgb(31,118,180)", "rgb(255,127,15)", "rgb(42,160,43)", "rgb(214,39,39)"])
  ...
  svg_stack.selectAll("mydots")
    ...
    .append("rect")
    .attr("x", 10)
    .attr("y", function (d, i) { return 330 + i * (size + 5) }) // 100 is where the first dot appears. 25 is the distance between dots
    .attr("width", size)
    .attr("height", size)
